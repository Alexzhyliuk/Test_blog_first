...
urlpatterns = [
    ...
    path("api/category/", api_views.CategoryListView.as_view(), name="api_category_list"),
    path("api/category/<category>", api_views.CategoryView.as_view(), name="api_category_post")
]
